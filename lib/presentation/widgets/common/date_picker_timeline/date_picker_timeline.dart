...
import 'package:healsense/presentation/widgets/common/date_picker_timeline/extra/style.dart';
import 'package:intl/date_symbol_data_local.dart';

import 'date_picker_timeline_widget.dart';
...
class DatePickerTimeline extends StatefulWidget {
  ...
  const DatePickerTimeline(
    ...
    this.selectedTextColor = AppColors.defaultDateBackColor,
...
class DatePickerTimelineState extends State<DatePickerTimeline> {
  ...
  void initState() {
    ...
    selectedDateStyle =
        widget.dateTextStyle.copyWith(color: widget.selectionColor);
    selectedMonthStyle =
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          DateTime date;
          DateTime dateValue = widget.startDate.add(Duration(days: index));
