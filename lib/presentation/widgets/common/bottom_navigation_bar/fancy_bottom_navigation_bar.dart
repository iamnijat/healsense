...
class FancyBottomNavigationBar extends StatefulWidget {
  const FancyBottomNavigationBar({
    Key? key,
    required this.tabs,
  ...
  @override
  FancyBottomNavigationBarState createState() =>
      FancyBottomNavigationBarState();
}

class FancyBottomNavigationBarState extends State<FancyBottomNavigationBar> {
  ...
  @override
  void didUpdateWidget(FancyBottomNavigationBar oldWidget) {
